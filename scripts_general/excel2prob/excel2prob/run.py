...
# 硬编码配置（改这里即可）
# ============================================================
EXCEL_DIR = "datas/backbone_data_suning-backend"  # 输入：话术 Excel 文件夹
YAML_PATH = "scripts_general/excel2prob/config/categories_M1-0918.yaml"  # 输入：类别定义 YAML
CANDIDATES_DIR = "datas/backbone_data_suning-backend/case/prob_generator/candidates"  # 中间产物目录
PROB_DIR = "datas/backbone_data_suning-backend/case/prob_generator/prob"  # 最终产物目录
