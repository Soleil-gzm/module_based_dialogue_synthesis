...
def load_and_format_prompt2(prompt_path, data, follow_info=None):
...
if __name__ == "__main__":
    ...
    if os.path.exists(COMBINATIONS_PATH):
        ...
        combos = loaded["combinations-M0-follow"]
    ...
    for combo in combos:
        ...
        for _ in range(n):
            ...
            prompt_system = load_and_format_prompt2(
                "generate_task/prompt/prompt_template_for_system1-new-follow.txt",
